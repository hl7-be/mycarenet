...
Description: "Ask for a new agreement by a physiotherapist with patient identified by national registration number"
Usage: #example
* type = #message
* timestamp = "2015-07-14T11:15:33+02:00"
* entry[0].fullUrl = "urn:uuid:ce2e2084-3f5c-4f52-8551-8088bb6d3491"
* entry[=].resource = Inline-Instance-for-ex03-1
...
* entry[=].resource = PractitionerRole2
* entry[+].fullUrl = "urn:uuid:8fc72085-d349-4bd7-ba84-91a935a4e3c6"
* entry[=].resource = Practitioner2
* entry[+].fullUrl = "urn:uuid:b3586cda-f1e5-4c58-a389-94249957d87a"
* entry[=].resource = Inline-Instance-for-ex03-7
* entry[+].fullUrl = "urn:uuid:3b8e1245-b480-4af6-90c0-f67037ef276b"
* entry[=].resource = ServiceRequest2
