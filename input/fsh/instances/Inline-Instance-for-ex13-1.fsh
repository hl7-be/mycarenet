Instance: Inline-Instance-for-ex13-1
InstanceOf: BeMyCareNetMessageHeader
Usage: #inline
* id = "667b18ce-3d37-4581-9baa-6fada338038c"
* eventCoding = $restful-interaction#search-type
* destination.endpoint = "urn:uuid:1dc5d974-5447-4afe-a4ab-57081ca518c3"
...
* response.code = #ok
* focus = Reference(SearchBundleResponse1)