...
* item.productOrService.coding.system = "https://www.ehealth.fgov.be/standards/fhir/terminology/CodeSystem/be-cs-mycarenet-nihdi-physiotherapy-pathologysituationcode" (exactly)
