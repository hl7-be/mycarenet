...
* item.adjudication.category.coding.system = $BeCSMyCareNetDecisionValues
* item.adjudication.category.coding.code 1..
* item.adjudication.reason.coding 1..1
* item.adjudication.reason.coding from $BeVSMyCareNetEAgreementAdjudicationReason (extensible)
* item.adjudication.reason.coding.system 1..
* item.adjudication.reason.coding.code 1..
* addItem MS
* addItem.itemSequence 1..1 MS
* addItem.productOrService from $BeVSMyCareNetProductOrServiceNihdiEAgreement (extensible)
